<template>
  ...
  <!-- <div
    class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 p-5 md:p-10 mt-15"
  >
...
<div class="max-w-sm mx-auto bg-white rounded-lg shadow-xl p-6">
  <div class="p-3 flex flex-col items-center">
    ...
    <p class="text-center text-base md:text-base">Nuestra dedicación y experiencia nos han llevado a ser líderes expertos</p>
    <div class="mt-3">
      <button type="button" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">Ver más</button>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 p-5 md:p-10 mt-15">
  <div class="max-w-sm mx-auto bg-white rounded-lg shadow-xl p-6">
    <div class="p-3 flex flex-col items-center">
      <p class="text-center font-black text-5xl md:text-7xl p-3 md:p-5 items-center drop-shadow-xl opacity-75">6+</p>
      <p class="text-center text-lg md:text-xl font-semibold">Proyectos Completados</p>
      <p class="text-center text-base md:text-base">Nos hemos especializado en la creación de soluciones digitales de excelencia y vanguardia</p>
      <div class="mt-3">
        <button type="button" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">Ver más</button>
  ...
  <div class="max-w-sm mx-auto bg-white rounded-lg shadow-xl p-6">
    <div class="p-3 flex flex-col items-center">
      <p class="text-center font-black text-5xl md:text-7xl p-3 md:p-5 items-center drop-shadow-xl opacity-75">5+</p>
      <p class="text-center text-lg md:text-xl font-semibold">Clientes</p>
      <p class="text-center text-base md:text-base">Nuestra sólida cartera de proyectos exitosos refleja la confianza de nuestros clientes y nuestro enfoque profesional en la satisfacción del cliente.</p>
      <div class="mt-3">
        <button type="button" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">Ver más</button>
  ...
  <div class="max-w-sm mx-auto bg-white rounded-lg shadow-xl p-6">
    <div class="p-3 flex flex-col items-center">
      <p class="text-center font-black text-5xl md:text-7xl p-3 md:p-5 items-center drop-shadow-xl opacity-75">4+</p>
      <p class="text-center text-lg md:text-xl font-semibold">Años de Experiencia</p>
      <p class="text-center text-base md:text-base">Nuestra dedicación y experiencia nos han llevado a ser líderes expertos</p>
      <div class="mt-3">
        <button type="button" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">Ver más</button>
  ...
  <div class="p-6">
    ...
    <p class="text-center text-base mt-3 grid place-content-center place-items-center">
      ...
      seguimiento de pedidos para una experiencia de compra satisfactoria.
    </p>
  </div>
</div>
