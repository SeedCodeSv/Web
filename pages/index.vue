<template>
  ...
  <div class="w-11/12 md:w-2/3 lg:w-1/2 xl:w-1/3 m-1 justify-center text-black shadow-2xl rounded-xl bg-white p-4">
    <div class="grid grid-cols-1 md:grid-cols-2">
      <div class="w-full h-56 md:h-full">
        <img class="rounded-xl w-full h-full object-cover" src="../../assets/css/img/img-card.jpg" />
      </div>
      <div class="md:px-5 w-full h-full grid place-content-center place-items-center">
        <p class="text-lg">
    ...
    <div class="mt-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-11 gap-y-11 mt-10">
